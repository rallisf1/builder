...
<style>
  ...
  .buttons-container .primo-buttons {
      padding: 0.5rem 1rem;
      margin: 0 auto;
      display: flex;
      flex: 1;
  ...
  .buttons-container .primo-buttons.deletable {
        grid-template-columns: 1fr 1fr auto;
      }

  .buttons-container .primo-buttons button {
  ...
  .buttons-container .primo-buttons button:hover {
          border-color: var(--primo-color-brand);
        }

  .buttons-container .primo-buttons button.delete {
          padding-left: 20px;
          padding-right: 20px;
        }

  .buttons-container .primo-buttons button:focus {
          outline: 0;
        }</style>
