 ...
 * */
export function buildStaticPage({ page, site, page_sections, page_symbols, locale, separateModules, no_js }: {
    page?: import('..').Page;
    site?: import('..').Site;
    page_sections?: import('..').Section[];
    page_symbols?: import('..').Symbol[];
...
export function getComponentData({ component, symbol, page, site, loc, include_parent_data }: {
    component: any;
    symbol?: any;
    page?: {
        id: any;
