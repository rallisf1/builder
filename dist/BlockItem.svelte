...
<style>
	...
	.primary-action.active .overlay, .primary-action:hover .overlay {
				opacity: 0.95;
			}
	...
	.component-wrapper header :global(svg) {
				width: 1rem;
			}

	.component-wrapper header .component-label {
				display: flex;
				align-items: center;
				flex: 1;
				padding-left: 0.5rem;
	...
	.component-wrapper header .component-label span {
					font-weight: 700;
					font-size: 0.75rem;
				}</style>
